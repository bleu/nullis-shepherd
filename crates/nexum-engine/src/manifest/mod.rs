...
// CapabilityViolation, ParseError, LoadedManifest, and the section
// structs are reachable through these functions' return / argument
// types; consumers that need to name them directly do so via
